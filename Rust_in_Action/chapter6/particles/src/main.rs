...
unsafe impl GlobalAlloc for ReportingAllocator {
    unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
        ...
        eprintln!("bytes allocates: {}\t time taken: {}", bytes_requested, time_taken.as_nanos());
        ptr
    }
...
impl Particle {
    fn new(world: &World) -> Particle {
        ...
        let y_accelaration: f64 = rng.gen_range(0.0..0.15);
        ...
        Particle {
            ...
            acceleration: [x_acceleration, y_accelaration].into(),
...
impl World {
    ...
    fn remove_shapres(&mut self, n: i32) {
        for _ in 0..n.abs() {
...
fn main() {
    ...
    ).exit_on_esc(true).build().expect("Couldnt create an window.");
